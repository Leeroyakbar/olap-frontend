...
export class OlapComponent implements OnInit {
      ...
      next: (res) => {
        ...
        switch (indexes.length) {
          ...
          case 2:
            ...
            break;
          case 3:
            this.data[indexes[0]].child[indexes[1]].child[indexes[2]].child =
              hasil;
            break;
          case 4:
            this.data[indexes[0]].child[indexes[1]].child[indexes[2]].child[
    ...
    if (query != undefined) {
            ...
            if (d[0].toString() === select) {
              ...
              switch (indexes.length) {
                ...
                case 2:
                  ...
                  break;
                case 3:
                  this.data[indexes[0]].child[indexes[1]].child[indexes[2]] =
                    hasil;
                  break;
                case 4:
                  this.data[indexes[0]].child[indexes[1]].child[
                    indexes[2]
                  ].child[indexes[3]] = hasil;
                  break;
                case 5:
                  this.data[indexes[0]].child[indexes[1]].child[
                    indexes[2]
                  ].child[indexes[3]].child[indexes[4]] = hasil;
                  break;
              }
            }
          });
      ...
      switch (indexes.length) {
        ...
        case 2:
          ...
          break;
        case 3:
          this.data[indexes[0]].child[indexes[1]].child[indexes[2]].modal =
            false;
          break;
        case 4:
          this.data[indexes[0]].child[indexes[1]].child[indexes[2]].child[
  ...
  setChart(data: IChart) {
    this.barChartData = {
      labels: data.labels,
      datasets: [{ data: data.values, label: 'Titik Panas' }],
    };
  }
}
